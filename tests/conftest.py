...
def stub_trait_catalogue() -> TraitCatalogue:
    """Build a small :class:`TraitCatalogue` for testing.
    ...
    return TraitCatalogue(
        {
            ...
            "test:locale.TimeZone": TraitDefinition(
                trait_id="test:locale.TimeZone",
                package="test",
                namespace="locale",
                member_name="TimeZone",
                version="1",
                description="Time zone locale trait",
                usage=["locale"],
                properties={
                    "timeZone": TraitProperty(
                        name="timeZone", type="string", description="The IANA time zone identifier"
                    ),
                },
            ),
        },
        specifications={
            ...
            "test:specification:locale.RegionalLocale": SpecificationDefinition(
                spec_id="test:specification:locale.RegionalLocale",
                package="test",
                namespace="locale",
                member_name="RegionalLocale",
                description="Regional locale specification",
                usage=["locale"],
                trait_ids=[
                    "test:locale.TimeZone",
                ],
            ),
        },
        ...
        namespace_descriptions={
            ...
            "test:locale": "Locale namespace description",
        },
    )
